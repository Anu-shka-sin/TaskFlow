...
const Layout = ({ onLogout, user }) => {
  ...
  const StatCard = ({ title, value, icon }) => (
    <div
      ...
      hover:shadow-md transition-all duration-300 hover:border-purple-100 group"
    >
      <div className="flex items-center gap-2">
        <div
          className="p-1.5 rounded-lg bg-gradient-to-br
          from-fuchsia-500/10 to-purple-500/10
          group-hover:from-fuchsia-500/20
        ...
        <div className="min-w-0">
          <p
            ...
            from-fuchsia-500 to-purple-600 bg-clip-text text-transparent"
          >
            {value}
          </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
     ...
     <div className="pt-16 p-3 sm:p-4 lg:ml-64 transition-all duration-300">
                  ...
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden">
                      <div
                        ...
                        from-fuchsia-500 to-purple-600 transition-all duration-500"
                        style={{
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0, 3).map((task) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-2 sm:p-3
                    hover:bg-purple-50/50 rounded-lg transition-colors duration-200
                  ...
                  >
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full shrink-0 mt-2 sm:mt-0 sm:ml-2 ${
                        task.completed
                ...
                {tasks.length === 0 && (
                  <div className="text-center py-4 sm:py-6 px-2">
                    <div
                      className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 rounded-full
